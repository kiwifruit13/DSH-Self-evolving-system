...
export type DomainErrorCode = 'NOT_FOUND' | 'OVERLAP_REJECTED' | 'INVALID_INPUT' | 'PARENT_NOT_FOUND' | 'CHILD_ALREADY_EXISTS' | 'MAX_DEPTH_EXCEEDED' | 'SPLIT_FAILED';
 ...
 */
export declare const DOMAIN_ERROR_CODES: ReadonlySet<DomainErrorCode>;
export declare const INFRA_ERROR_CODE: InfraErrorCode;
export declare const ALL_ERROR_CODES: ReadonlySet<ErrorCode>;
export declare function isDomainError(code: string): code is DomainErrorCode;
/** 领域失败的规范信封 */
 ...
 */
export declare function parseErrorCode(message: string): DomainErrorCode | null;
export declare function rpcError(code: ErrorCode, message: string): RpcErrorEnvelope;
export declare function toError(code: ErrorCode, message: string): Error;
